                                ...
                                <div className="flex border-b-2 border-black overflow-x-auto scrollbar-hide bg-white rounded-t-xl -mb-px print:hidden">
                                    {(['METRICS', 'ASISTENCIAS', 'BAJAS', 'INTERACCIONES'] as GroupsSubTab[]).map((tab) => (
                                        <button
                                            ...
                                            className={`px-5 py-3.5 text-[11px] font-black uppercase tracking-widest whitespace-nowrap transition-all border-b-[3px] -mb-px shrink-0 ${groupsSubTab === tab
                                        ...
                                        {registrationAnalytics && (
                                            <div className="bg-white p-4 md:p-8 border-2 border-black rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] mb-4 md:mb-6">
                                                ...
                                                <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 md:gap-4">
                                                    {/* Card 1: Grupos */}
                                                    <div className="border-2 border-black p-5 bg-white shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] flex flex-col justify-between min-h-[130px]">
                                                        ...
                                                        <p className="text-5xl md:text-6xl font-black text-black leading-none mt-2">
                                                            {registrationAnalytics.totalGroups}
                                                        </p>
                                                        <p className="text-[10px] font-medium text-neutral-400 mt-2">Total de grupos</p>
                                                    </div>

                                                    {/* Card 2: Anfitriones */}
                                                    <div className="border-2 border-black p-5 bg-white shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] flex flex-col justify-between min-h-[130px]">
                                                        <p className="text-[9px] font-black uppercase tracking-[0.2em] text-neutral-400">Anfitriones</p>
                                                        <p className="text-5xl md:text-6xl font-black text-black leading-none mt-2">
                                                            {registrationAnalytics.totalHosts}
                                                        </p>
                                                        <p className="text-[10px] font-medium text-neutral-400 mt-2">Líderes principales únicos</p>
                                                    </div>

                                                    {/* Card 3: Co-Anfitriones */}
                                                    <div className="border-2 border-black p-5 bg-white shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] flex flex-col justify-between min-h-[130px]">
                                                        <p className="text-[9px] font-black uppercase tracking-[0.2em] text-neutral-400">Co-Anfitriones</p>
                                                        <p className="text-5xl md:text-6xl font-black text-black leading-none mt-2">
                                                            {registrationAnalytics.totalCoHosts}
                                                        </p>
                                                        <p className="text-[10px] font-medium text-neutral-400 mt-2">Líderes de apoyo únicos</p>
                                                    </div>

                                                    {/* Card 4: Personas Únicas */}
                                                    <div className="border-2 border-black p-5 bg-white shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] flex flex-col justify-between min-h-[130px]">
                                                        <p className="text-[9px] font-black uppercase tracking-[0.2em] text-neutral-400">Personas Únicas</p>
                                                        <p className="text-5xl md:text-6xl font-black text-black leading-none mt-2">
                                                            {registrationAnalytics.uniquePeople}
                                                        </p>
                                                        <p className="text-[10px] font-medium text-neutral-400 mt-2">Usuarios distintos inscriptos</p>
                                                    </div>

                                                    {/* Card 5: Inscripciones Totales — hero card */}
                                                    <div className="border-2 border-black p-5 bg-black col-span-2 lg:col-span-1 shadow-[3px_3px_0px_0px_rgba(245,158,11,1)] flex flex-col justify-between min-h-[130px]">
                                                        <p className="text-[9px] font-black uppercase tracking-[0.2em] text-amber-500">Inscripciones Totales</p>
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div className="flex-1 min-w-0">
                                                                            <p className="font-bold text-xs text-black truncate mb-1">{item.name}</p>
                                                        ...
                                                        <div className="block h-[400px] md:h-[560px] mt-4">
                                                            <ResponsiveContainer width="100%" height="100%">
                                                                <BarChart data={filteredGroups} layout="vertical" margin={{ top: 5, right: 50, left: 8, bottom: 5 }}>
                                                                    ...
                                                                    <YAxis type="category" dataKey="name" axisLine={false} tickLine={false} tick={{ fill: '#000', fontSize: 10, fontWeight: '700' }} width={140} />
                                                                    <Tooltip
